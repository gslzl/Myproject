...
public class PersonalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserBean userBean_show = (UserBean) intent.getSerializableExtra("user_bean");
        Glide.with(this)
                .load(userBean_show.data.getAvatar())
                .into(headImage);
        name.setText(userBean_show.data.getName());
        address.setText(userBean_show.data.getAddress());
        phonenumber.setText(userBean_show.data.getAddress_phone());
    }
